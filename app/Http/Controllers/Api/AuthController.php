...
class AuthController extends Controller
{
    public function register(Request $request)
    {
        ...
        $notifyRegistration = AppSetting::get('notify_registration_enabled', 'true') === 'true';
        if ($notifyRegistration) {
            try {
                MailService::sendTo($user->email, 'Welcome to ' . AppSetting::get('mail_from_name', 'MedFootApp'), 'emails.welcome', [
                    'userName' => $user->name,
